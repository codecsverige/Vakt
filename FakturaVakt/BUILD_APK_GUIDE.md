...
## 📋 المحتويات
- [للـ Agents - دليل سريع](#للـ-agents---دليل-سريع)
...
# 2. ابني APK
export ANDROID_HOME=~/android-sdk && ./build-apk.sh

# 3. انتظر حتى ترى "BUILD SUCCESSFUL"
...
### أمر واحد لكل شيء:
```bash
cd /workspace/FakturaVakt && export ANDROID_HOME=~/android-sdk && ./build-apk.sh && echo "APK Location: $(pwd)/android/app/build/outputs/apk/release/app-release.apk"
```
